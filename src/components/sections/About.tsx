  ...
  const experience = [
    {
      ...
      description: 'Leading development of enterprise AI agents and voice automation solutions'
    },
    {
      year: '2022-2024',
      title: 'Full Stack Developer',
      company: 'Digital Solutions Inc',
      description: 'Built scalable web applications and integrated AI/ML capabilities'
    },
    {
      year: '2021-2022',
      title: 'Software Engineer',
      company: 'StartupTech',
      description: 'Developed mobile and web applications with focus on user experience'
    }
  ]
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              I'm a passionate AI engineer specializing in creating intelligent solutions 
